...
def get_settings_from_env(controller_port=None,
    ...
    to enable backwards compatibility with previous versions of this script:
        visualization_server_image: registry.app.corpintra.net/dna/ml-pipeline/visualization-server
        visualization_server_tag: value of KFP_VERSION environment variable
        frontend_image: registry.app.corpintra.net/dna/ml-pipeline/frontend
    ...
    settings["visualization_server_image"] = \
        ...
        os.environ.get("VISUALIZATION_SERVER_IMAGE", "registry.app.corpintra.net/dna/ml-pipeline/visualization-server")

    settings["frontend_image"] = \
        frontend_image or \
        os.environ.get("FRONTEND_IMAGE", "registry.app.corpintra.net/dna/ml-pipeline/frontend")
