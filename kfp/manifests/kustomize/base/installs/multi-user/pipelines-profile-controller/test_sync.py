...
DEFAULT_FRONTEND_IMAGE = "registry.app.corpintra.net/dna/ml-pipeline/frontend"
DEFAULT_VISUALIZATION_IMAGE = "registry.app.corpintra.net/dna/ml-pipeline/visualization-server"
